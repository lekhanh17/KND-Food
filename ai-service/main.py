...
class RecommendRequest(BaseModel):
    ...
    # interactions cho phép rỗng nếu Backend chưa gửi kq
...
def recommend(req: RecommendRequest):
    ...
    # ==========================================
    # LUỒNG 1: TF-IDF (DỰA TRÊN NỘI DUNG)
    # ==========================================
    ...
    # Danh sách từ khóa gia vị & đơn vị đo
    vietnamese_stop_words = [
        "muối", "bột canh","đường", "bột", "ngọt", "hạt", "nêm", "tiêu", "tỏi", "ớt", 
    ...
    # Đưa dsach vào TF-IDF để AI bỏ qua gia vị
    ...
    # ==========================================
    # Tạo sẵn mt toàn số 0 phòng trường hợp web chưa ai tương tác
    ...
    if req.interactions:
        ...
        # Xây dựng bảng mt: Hàng là Món, Cột là User, Ô là Điểm
    ...
    # ======================================================================
    # alpha = 0.2 nghĩa là 80% tính chất nguyên liệu + 20% hành vi người dùng
    alpha = 0.2 
    ...
    # Bỏ món gốc ra khỏi dsach tính toán
