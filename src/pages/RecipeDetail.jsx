          ...
          {recipe.VideoURL ? (
            ...
            recipe.VideoURL.includes("youtu.be") ? (
              ...
              <video
                src={recipe.VideoURL}
                controls
                className="max-w-full max-h-full object-contain rounded-3xl shadow-lg bg-black"
              ></video>
            )
          ) : (
            <img
        ...
        <div className="bg-white rounded-[2rem] p-6 md:p-10 shadow-sm border border-gray-100">
          <div className="flex flex-col md:flex-row justify-between items-start gap-6 mb-8">
            <div className="flex-1">
              ...
              <div className="flex flex-wrap items-center gap-3 mt-6">
                <button
                  ...
                  disabled={isSaving}
                  className={`px-5 py-2.5 rounded-xl font-bold text-sm transition-all flex items-center gap-2 ${isSaved ? "bg-red-50 text-red-500 hover:bg-red-100" : "bg-gray-50 text-gray-500 border border-gray-200 hover:text-red-500 hover:border-red-200"}`}
                >
                  <FontAwesomeIcon
                    icon={faHeart}
            ...
            >
              ...
              <div className="pr-2">
                <p className="text-[10px] text-gray-400 font-bold uppercase tracking-wider mb-0.5 group-hover:text-orange-500 transition-colors">
                  Tác giả
                </p>
                <p className="font-bold text-sm text-gray-900 group-hover:text-orange-600 transition-colors">
                  {recipe.FullName}
                </p>
              </div>
            </Link>
