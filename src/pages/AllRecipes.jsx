      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="mb-10 flex flex-col sm:flex-row sm:items-end justify-between gap-6">
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5 text-orange-500 shrink-0">
                <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 6h9.75M10.5 6a1.5 1.5 0 11-3 0m3 0a1.5 1.5 0 10-3 0M3.75 6H7.5m3 12h9.75m-9.75 0a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m-3.75 0H7.5m9-6h3.75m-3.75 0a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m-9.75 0h9.75" />
              </svg>
              <span className="text-gray-500 font-bold text-sm hidden md:block">Sắp xếp:</span>
              
              <div className="flex items-center gap-2">
                <span className="font-bold text-[#1c2b36]">
                  {sortOptions.find(opt => opt.value === sortBy)?.label}
                </span>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={`w-4 h-4 text-gray-400 transition-transform duration-200 ${isDropdownOpen ? 'rotate-180 text-orange-500' : ''}`}>
        ...
        {loading ? (
          ...
          <div className="text-center py-20 bg-white rounded-3xl border border-gray-100 shadow-sm flex flex-col items-center">
            ...
            <p className="text-gray-500 font-medium">Chưa có công thức nào thuộc danh mục này.</p>
          </div>
        )}
