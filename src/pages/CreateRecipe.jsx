...
export default function CreateRecipe() {
  ...
  useEffect(() => {
    ...
    if (!token) {
      toast.warning("Bạn cần đăng nhập để chia sẻ công thức nhé!", {
        ...
        theme: "light",
        className:
          "!bg-white !text-gray-800 !rounded-[16px] !shadow-xl !border !border-gray-100 !font-bold !text-sm",
      });
      navigate("/login");
    }
  }, [navigate]);
  ...
  const handleSubmit = async (e) => {
    ...
    if (validIngredients.length === 0)
      return showWarning("Vui lòng thêm ít nhất 1 nguyên liệu!");
    if (validSteps.length === 0)
      return showWarning("Vui lòng thêm ít nhất 1 bước thực hiện!");
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        <div className="mb-8">
          ...
          <p className="text-gray-500 mt-2 font-medium">
            Chia sẻ công thức nấu ăn của bạn tới cộng đồng.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8" noValidate>
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <svg
                      ...
                      strokeWidth={2}
                      stroke="currentColor"
                      className={`w-4 h-4 text-gray-500 transition-transform ${isDropdownOpen ? "rotate-180 text-orange-500" : ""}`}
                    >
                      <path
                        strokeLinecap="round"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:border-orange-500 font-medium"
                  />
                </div>
                <div>
                  <label className="block text-sm font-bold text-gray-700 mb-2">
            ...
            <div className="space-y-6">
              <div>
                <label className="block text-sm font-bold text-gray-700 mb-3">
                  Ảnh thành phẩm <span className="text-red-500">*</span>
                </label>
                <div
                  ...
                  {imagePreview ? (
                    <>
                      ...
                      <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-all">
                        <span className="text-white font-bold px-4 py-2 bg-black/50 rounded-lg backdrop-blur-sm">
                          Thay đổi ảnh
                        </span>
                      </div>
                    </>
                    ...
                    <div className="text-center p-6">
                      <svg
                        ...
                        strokeWidth={1.5}
                        stroke="currentColor"
                        className="w-12 h-12 mx-auto text-gray-400 mb-3 group-hover:text-orange-500 transition-colors"
                      >
                        <path
                          strokeLinecap="round"
                          strokeLinejoin="round"
              ...
              <div>
                <div className="flex items-end justify-between mb-3">
                  ...
                  <div className="flex bg-gray-100 p-1 rounded-lg">
                    <button
                      ...
                      className={`px-4 py-1.5 text-xs font-bold rounded-md transition-all ${videoInputType === "upload" ? "bg-white text-orange-600 shadow-sm" : "text-gray-500 hover:text-gray-700"}`}
                    >
                      Tải lên
                    </button>
                    <button
                      ...
                      className={`px-4 py-1.5 text-xs font-bold rounded-md transition-all ${videoInputType === "link" ? "bg-white text-orange-600 shadow-sm" : "text-gray-500 hover:text-gray-700"}`}
                    >
                      Link Video
                    </button>
                  </div>
                ...
                {videoInputType === "upload" ? (
                  ...
                  <div className="relative border border-gray-200 rounded-xl overflow-hidden focus-within:border-orange-500 focus-within:ring-2 focus-within:ring-orange-500/50 transition-all bg-gray-50 flex items-center">
                    ...
                    <input
                      type="url"
                      placeholder="Hãy thêm đường dẫn..."
                      value={videoUrl}
                      onChange={(e) => setVideoUrl(e.target.value)}
                      className="w-full py-4 pr-4 bg-transparent outline-none font-medium placeholder-gray-400"
                    />
                  </div>
                )}
              </div>
          ...
          <div className="bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-gray-100">
            ...
            <div className="space-y-3">
              {ingredients.map((ing, index) => (
                <div
                  key={index}
                  className="flex flex-col sm:flex-row gap-3 group animate-in fade-in slide-in-from-bottom-2 duration-300"
                >
                  ...
                  <div className="flex gap-3 sm:w-[40%]">
                    ...
                    <button
                      ...
                      className={`w-12 flex items-center justify-center rounded-xl bg-red-50 text-red-500 hover:bg-red-100 transition-colors ${ingredients.length === 1 ? "opacity-30 cursor-not-allowed" : "opacity-100 sm:opacity-0 group-hover:opacity-100"}`}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
            ...
            <button
              ...
              className="mt-5 px-5 py-2.5 bg-orange-50 text-orange-600 hover:bg-orange-100 rounded-xl font-bold text-sm transition-colors flex items-center gap-2"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 20 20"
          ...
          <div className="bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-gray-100">
            ...
            <div className="space-y-6">
              {steps.map((step, index) => (
                <div
                  key={index}
                  className="flex gap-4 group animate-in fade-in slide-in-from-bottom-2 duration-300 relative"
                >
                  <div className="pt-2">
                  ...
                  <div className="flex-1 flex flex-col sm:flex-row gap-4 items-stretch">
                    <div className="flex-1 relative">
                      <textarea
                        ...
                        className="w-full h-full min-h-[120px] px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500/50 focus:border-orange-500 transition-all resize-none font-medium text-gray-700"
                      ></textarea>
                    </div>
                    ...
                    <button
                      ...
                      className={`absolute -right-3 -top-3 w-7 h-7 rounded-full bg-white border border-gray-200 text-red-500 hover:bg-red-50 transition-colors shadow-md flex items-center justify-center z-10 ${steps.length === 1 ? "hidden" : "opacity-100 sm:opacity-0 group-hover:opacity-100"}`}
                      title="Xóa bước này"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="flex justify-end gap-4 pt-4">
            ...
            <button
              type="submit"
              className="px-10 py-4 bg-orange-500 text-white rounded-2xl font-black hover:bg-orange-600 shadow-lg shadow-orange-500/30 transition active:scale-95 tracking-wide"
            >
              Đăng Công Thức
            </button>
          </div>
